...
# Create a test script file and run it
cmd = '''
cat > /tmp/test-bcrypt.js << 'SCRIPT'
...
async function test() {
  ...
  const testPasswords = ['Test123!', 'test123!', 'Test123', 'password', 'Summit123!'];
...
cd /var/www/summit/server && node /tmp/test-bcrypt.js
'''
