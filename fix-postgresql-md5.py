...
print("🔧 Fixing PostgreSQL to Use MD5")

command = """
export HOME=/home/ubuntu

echo "=== Update postgresql.conf to use md5 ==="
sudo sed -i "s/^#password_encryption = .*/password_encryption = md5/" /etc/postgresql/*/main/postgresql.conf
sudo sed -i "s/^password_encryption = .*/password_encryption = md5/" /etc/postgresql/*/main/postgresql.conf

echo ""
echo "=== Verify change ==="
sudo grep "password_encryption" /etc/postgresql/*/main/postgresql.conf
