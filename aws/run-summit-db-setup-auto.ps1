# Auto-run Summit Database Setup via AWS SSM (No prompts)
...
Write-Host "Target Database: $DB_NAME ONLY" -ForegroundColor Yellow
...
Write-Host "🚀 Running setup via SSM..." -ForegroundColor Green
