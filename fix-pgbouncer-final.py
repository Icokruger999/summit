...
print("🔧 Fixing PgBouncer with Plain Password")

command = """
export HOME=/home/ubuntu

echo "=== Fix pgbouncer userlist with plain password ==="
echo '"summit_user" "KUQoTLZJcHN0YYXS6qiGJS9B7"' | sudo tee /etc/pgbouncer/userlist.txt
