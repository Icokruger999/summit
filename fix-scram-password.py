...
print("🔧 Fixing SCRAM Password")

command = """
export HOME=/home/ubuntu

echo "=== Check PostgreSQL password encryption ==="
sudo -u postgres psql -c "SHOW password_encryption;"

echo ""
echo "=== Reset summit_user password with SCRAM ==="
...
PGPASSWORD=KUQoTLZJcHN0YYXS6qiGJS9B7 psql -h 127.0.0.1 -U summit_user -d summit -c "SELECT 'Works!' as status;"
